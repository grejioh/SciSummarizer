...
class ArxivFetcher:
    def __init__(self, max_results: int = 5, sort_by: arxiv.SortCriterion = arxiv.SortCriterion.Relevance):
    ...
    async def download_pdf(self, paper: Dict[str, Any], output_dir: str = 'data/pdfs') -> str:
        """
